# Calculate chess knight moves to targetLocation

A simple ELM app with minimal interaction that calculates moves required by a knight to reach target square.
